import { r as registerInstance, h, H as Host, e as getElement, d as createEvent, f as readTask, i as forceUpdate, w as writeTask } from './index-2cd7e630.js';
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-a175fa73.js';
import { c as clamp } from './helpers-d8b49b57.js';
import { t as transition } from './index-157155ee.js';
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-8339ee48.js').then(module => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-fc3f3eb7.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-af289659.js').then(module => module.startInputShims(config));
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-784b7e3c.js').then(module => module.startHardwareBackButton());
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await import('./swipe-back-69ef585b.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
