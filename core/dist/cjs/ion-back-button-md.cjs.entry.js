...
const BackButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onClick: this.onClick, class: Object.assign(Object.assign({}, theme.createColorClasses(color)), { [mode]: true, 'button': true, 'back-button-disabled': disabled, 'back-button-has-icon-only': hasIconOnly, 'in-toolbar': theme.hostContext('ion-toolbar', this.el), 'in-toolbar-color': theme.hostContext('ion-toolbar[color]', this.el), 'ion-activatable': true, 'ion-focusable': true, 'show-back-button': showBackButton }) }, index.h("button", { type: type, disabled: disabled, class: "button-native", part: "button" }, index.h("span", { class: "button-inner" }, backButtonIcon && index.h("ion-icon", { icon: backButtonIcon, lazy: false, part: "icon" }), backButtonText && index.h("span", { class: "button-text", part: "text" }, backButtonText)), mode === 'md' && index.h("ion-ripple-effect", { type: this.rippleType }))));
    }
