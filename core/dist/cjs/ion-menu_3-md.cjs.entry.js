...
const Menu = class {
    constructor(hostRef) {
        ...
        this.lastOnEnd = 0;
        this.blocker = index$2.GESTURE_CONTROLLER.createBlocker({ disableScroll: true });
...
`);
        ...
        index$3.menuController._register(this);
        this.gesture = (await new Promise(function (resolve) { resolve(require('./index-a3a13ea1.js')); })).createGesture({
            el: document,
    ...
    disconnectedCallback() {
        ...
        index$3.menuController._unregister(this);
        if (this.animation) {
    ...
    setOpen(shouldOpen, animated = true) {
        return index$3.menuController._setOpen(this, shouldOpen, animated);
    }
    ...
    async loadAnimation() {
        ...
        this.animation = await index$3.menuController._createAnimation(this.type, this);
    ...
    canStart(detail) {
        ...
        else if (index$3.menuController._getOpenSync()) {
            return false;
        }
    ...
    updateState() {
        ...
        if (!this.disabled) {
            index$3.menuController._setActiveMenu(this);
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "navigation", class: {
            ...
            } }, index.h("div", { class: "menu-inner", ref: el => this.menuInnerEl = el }, index.h("slot", null)), index.h("ion-backdrop", { ref: el => this.backdropEl = el, class: "menu-backdrop", tappable: false, stopPropagation: false })));
    }
...
const MenuButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: Object.assign(Object.assign({ [mode]: true }, theme.createColorClasses(color)), { 'button': true, 'menu-button-hidden': hidden, 'menu-button-disabled': disabled, 'in-toolbar': theme.hostContext('ion-toolbar', this.el), 'in-toolbar-color': theme.hostContext('ion-toolbar[color]', this.el), 'ion-activatable': true, 'ion-focusable': true }) }, index.h("button", Object.assign({}, attrs, { disabled: disabled, class: "button-native" }), index.h("span", { class: "button-inner" }, index.h("slot", null, index.h("ion-icon", { icon: menuIcon, mode: mode, lazy: false }))), mode === 'md' && index.h("ion-ripple-effect", { type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
MenuButton.style = {
