...
const Radio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "radio", "aria-disabled": disabled ? 'true' : null, "aria-checked": `${checked}`, "aria-labelledby": labelId, class: Object.assign(Object.assign({}, theme.createColorClasses(color)), { [mode]: true, 'in-item': theme.hostContext('ion-item', el), 'interactive': true, 'radio-checked': checked, 'radio-disabled': disabled }) }, index.h("div", { class: "radio-icon" }, index.h("div", { class: "radio-inner" })), index.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: disabled })));
    }
...
const RadioGroup = class {
    ...
    render() {
        return (index.h(index.Host, { role: "radiogroup", "aria-labelledby": this.labelId, onClick: this.onClick, class: ionicGlobal.getIonMode(this) }));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueChanged"]
