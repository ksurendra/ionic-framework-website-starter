...
const Toast = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { style: {
            ...
            }, class: Object.assign(Object.assign(Object.assign({ [mode]: true }, theme.createColorClasses(this.color)), theme.getClassMap(this.cssClass)), { 'toast-translucent': this.translucent }), onIonToastWillDismiss: this.dispatchCancelHandler }, index.h("div", { class: wrapperClass }, index.h("div", { class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), index.h("div", { class: "toast-content" }, this.header !== undefined &&
