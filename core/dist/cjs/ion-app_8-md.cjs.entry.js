...
const index$1$1 = require('./index-9d18c2c1.js');
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!ionicGlobal.config.getBoolean('_testing')) {
                    new Promise(function (resolve) { resolve(require('./tap-click-92eabd18.js')); }).then(module => module.startTapClick(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./status-tap-4085c7fc.js')); }).then(module => module.startStatusTap());
                }
                if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
                    new Promise(function (resolve) { resolve(require('./input-shims-3dba6745.js')); }).then(module => module.startInputShims(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('hardwareBackButton', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./hardware-back-button-9af398da.js')); }).then(module => module.startHardwareBackButton());
                }
                new Promise(function (resolve) { resolve(require('./focus-visible-2fe3eac8.js')); }).then(module => module.startFocusVisible());
            });
        }
    }
    render() {
...
const Content = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'content-sizing': theme.hostContext('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
            ...
            } }, index.h("div", { id: "background-content" }), index.h("main", { class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                'overscroll': (scrollX || scrollY) && forceOverscroll
            }, ref: el => this.scrollEl = el, onScroll: (this.scrollEvents) ? ev => this.onScroll(ev) : undefined }, index.h("slot", null)), transitionShadow ? (index.h("div", { class: "transition-effect" }, index.h("div", { class: "transition-cover" }), index.h("div", { class: "transition-shadow" }))) : null, index.h("slot", { name: "fixed" })));
    }
    get el() { return index.getElement(this); }
};
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-84ada672.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
    ...
    async transition(enteringEl, leavingEl, opts = {}) {
        ...
        await index$1$1.transition(Object.assign({ mode,
            animated,
            animationBuilder,
            enteringEl,
