...
const Loading = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { onIonBackdropTap: this.onBackdropTap, style: {
                zIndex: `${40000 + this.overlayIndex}`
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'loading-translucent': this.translucent }) }, index.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), index.h("div", { class: "loading-wrapper", role: "dialog" }, spinner && (index.h("div", { class: "loading-spinner" }, index.h("ion-spinner", { name: spinner }))), message && index.h("div", { class: "loading-content", innerHTML: index$1.sanitizeDOMString(message) }))));
    }
