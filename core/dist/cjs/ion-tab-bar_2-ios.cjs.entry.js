...
const TabBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "tablist", "aria-hidden": keyboardVisible ? 'true' : null, class: Object.assign(Object.assign({}, theme.createColorClasses(color)), { [mode]: true, 'tab-bar-translucent': translucent, 'tab-bar-hidden': keyboardVisible }) }, index.h("slot", null)));
    }
...
const TabButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onClick: this.onClick, onKeyup: this.onKeyUp, role: "tab", tabindex: tabIndex, "aria-selected": selected ? 'true' : null, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                ...
                'ion-selectable': true,
                'ion-focusable': true
            } }, index.h("a", Object.assign({}, attrs, { tabIndex: -1, class: "button-native" }), index.h("span", { class: "button-inner" }, index.h("slot", null)), mode === 'md' && index.h("ion-ripple-effect", { type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
TabButton.style = {
