...
const SegmentButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null, class: {
                ...
                'ion-focusable': true,
            } }, index.h("button", { type: type, "aria-pressed": checked ? 'true' : null, class: "button-native", disabled: disabled }, index.h("span", { class: "button-inner" }, index.h("slot", null)), mode === 'md' && index.h("ion-ripple-effect", null)), index.h("div", { part: "indicator", class: {
