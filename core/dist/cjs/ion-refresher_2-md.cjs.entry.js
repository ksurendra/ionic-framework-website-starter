...
require('./index-9d18c2c1.js');
require('./ios.transition-e4e04d3b.js');
require('./md.transition-48228b1e.js');
const cubicBezier = require('./cubic-bezier-7fd071cd.js');
require('./index-a3a13ea1.js');
require('./hardware-back-button-9af398da.js');
require('./index-f3835a2d.js');
require('./overlays-14910fc2.js');
const index$1$2 = require('./index-d930391e.js');
const spinnerConfigs = require('./spinner-configs-04195544.js');
...
const Refresher = class {
    ...
    checkNativeRefresher() {
        const useNativeRefresher = shouldUseNativeRefresher(this.el, ionicGlobal.getIonMode(this));
    ...
    async connectedCallback() {
        ...
        if (shouldUseNativeRefresher(this.el, ionicGlobal.getIonMode(this))) {
            this.setupNativeRefresher(contentEl);
        }
        else {
            this.gesture = (await new Promise(function (resolve) { resolve(require('./index-a3a13ea1.js')); })).createGesture({
...
const RefresherContent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: mode }, index.h("div", { class: "refresher-pulling" }, this.pullingIcon && hasSpinner &&
            ...
            index.h("div", { class: "refresher-pulling-text", innerHTML: index$1$2.sanitizeDOMString(this.pullingText) })), index.h("div", { class: "refresher-refreshing" }, this.refreshingSpinner &&
            index.h("div", { class: "refresher-refreshing-icon" }, index.h("ion-spinner", { name: this.refreshingSpinner })), this.refreshingText &&
            index.h("div", { class: "refresher-refreshing-text", innerHTML: index$1$2.sanitizeDOMString(this.refreshingText) }))));
    }
    get el() { return index.getElement(this); }
};
