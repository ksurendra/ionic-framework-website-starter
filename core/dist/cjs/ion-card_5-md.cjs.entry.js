...
const Card = class {
    ...
    renderCard(mode) {
        ...
        return (index.h(TagType, Object.assign({}, attrs, { class: "card-native", disabled: this.disabled, onClick: (ev) => theme.openURL(href, ev, routerDirection) }), index.h("slot", null), clickable && mode === 'md' && index.h("ion-ripple-effect", null)));
    }
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { class: Object.assign(Object.assign({ [mode]: true }, theme.createColorClasses(this.color)), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    }
};
Card.style = {
...
const CardHeader = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { 'card-header-translucent': this.translucent, 'ion-inherit-color': true, [mode]: true }) }, index.h("slot", null)));
    }
};
CardHeader.style = {
...
const CardSubtitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { role: "heading", "aria-level": "3", class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { 'ion-inherit-color': true, [mode]: true }) }, index.h("slot", null)));
    }
};
CardSubtitle.style = {
...
const CardTitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { role: "heading", "aria-level": "2", class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { 'ion-inherit-color': true, [mode]: true }) }, index.h("slot", null)));
    }
};
CardTitle.style = {
