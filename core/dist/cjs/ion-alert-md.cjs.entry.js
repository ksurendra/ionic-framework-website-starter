...
const index$1 = require('./index-d930391e.js');
...
const Alert = class {
    ...
    renderCheckbox(labelledby) {
        ...
        return (index.h("div", { class: "alert-checkbox-group", "aria-labelledby": labelledby }, inputs.map(i => (index.h("button", { type: "button", onClick: () => this.cbClick(i), "aria-checked": `${i.checked}`, id: i.id, disabled: i.disabled, tabIndex: 0, role: "checkbox", class: {
                'alert-tappable': true,
                'alert-checkbox': true,
                'alert-checkbox-button': true,
                'ion-focusable': true,
                'alert-checkbox-button-disabled': i.disabled || false
            } }, index.h("div", { class: "alert-button-inner" }, index.h("div", { class: "alert-checkbox-icon" }, index.h("div", { class: "alert-checkbox-inner" })), index.h("div", { class: "alert-checkbox-label" }, i.label)), mode === 'md' && index.h("ion-ripple-effect", null))))));
    }
    renderRadio(labelledby) {
        ...
        return (index.h("div", { class: "alert-radio-group", role: "radiogroup", "aria-labelledby": labelledby, "aria-activedescendant": this.activeId }, inputs.map(i => (index.h("button", { type: "button", onClick: () => this.rbClick(i), "aria-checked": `${i.checked}`, disabled: i.disabled, id: i.id, tabIndex: 0, class: {
                'alert-radio-button': true,
                'alert-tappable': true,
                'alert-radio': true,
                'ion-focusable': true,
                'alert-radio-button-disabled': i.disabled || false
            }, role: "radio" }, index.h("div", { class: "alert-button-inner" }, index.h("div", { class: "alert-radio-icon" }, index.h("div", { class: "alert-radio-inner" })), index.h("div", { class: "alert-radio-label" }, i.label)))))));
    }
    renderInput(labelledby) {
        ...
        return (index.h("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => {
            if (i.type === 'textarea') {
                return (index.h("div", { class: "alert-input-wrapper" }, index.h("textarea", { placeholder: i.placeholder, value: i.value, onInput: e => i.value = e.target.value, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
                        'alert-input-disabled': i.disabled || false
                    } })));
            }
            else {
                return (index.h("div", { class: "alert-input-wrapper" }, index.h("input", { placeholder: i.placeholder, value: i.value, type: i.type, min: i.min, max: i.max, onInput: e => i.value = e.target.value, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
                        'alert-input-disabled': i.disabled || false
                    } })));
            }
