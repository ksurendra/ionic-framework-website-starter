...
const Item = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null, class: Object.assign(Object.assign(Object.assign({}, childStyles), theme.createColorClasses(this.color)), { 'item': true, [mode]: true, [`item-lines-${lines}`]: lines !== undefined, 'item-disabled': disabled, 'in-list': theme.hostContext('ion-list', this.el), 'item-multiple-inputs': this.multipleInputs, 'ion-activatable': canActivate, 'ion-focusable': true }) }, index.h(TagType, Object.assign({}, attrs, { class: "item-native", disabled: disabled, onClick: (ev) => theme.openURL(href, ev, routerDirection) }), index.h("slot", { name: "start" }), index.h("div", { class: "item-inner" }, index.h("div", { class: "input-wrapper" }, index.h("slot", null)), index.h("slot", { name: "end" }), showDetail && index.h("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon" }), index.h("div", { class: "item-inner-highlight" })), canActivate && mode === 'md' && index.h("ion-ripple-effect", null)), index.h("div", { class: "item-highlight" })));
    }
...
const ItemDivider = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'item-divider-sticky': this.sticky, 'item': true }) }, index.h("slot", { name: "start" }), index.h("div", { class: "item-divider-inner" }, index.h("div", { class: "item-divider-wrapper" }, index.h("slot", null)), index.h("slot", { name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
ItemDivider.style = {
...
const Label = class {
    ...
    render() {
        const position = this.position;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, [`label-${position}`]: position !== undefined, [`label-no-animate`]: (this.noAnimate) }) }));
    }
    get el() { return index.getElement(this); }
...
const ListHeader = class {
    ...
    render() {
        const { lines } = this;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, [`list-header-lines-${lines}`]: lines !== undefined }) }, index.h("div", { class: "list-header-inner" }, index.h("slot", null))));
    }
};
ListHeader.style = {
