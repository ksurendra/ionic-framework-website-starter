...
const ActionSheet = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "dialog", "aria-modal": "true", style: {
            ...
            }, class: Object.assign(Object.assign({ [mode]: true }, theme.getClassMap(this.cssClass)), { 'action-sheet-translucent': this.translucent }), onIonActionSheetWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, index.h("ion-backdrop", { tappable: this.backdropDismiss }), index.h("div", { class: "action-sheet-wrapper", role: "dialog" }, index.h("div", { class: "action-sheet-container" }, index.h("div", { class: "action-sheet-group" }, this.header !== undefined &&
