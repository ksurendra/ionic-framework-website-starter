...
export class Content {
    ...
    render() {
        ...
        return (h(Host, { class: Object.assign(Object.assign({}, createColorClasses(this.color)), { [mode]: true, 'content-sizing': hostContext('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
            ...
            h("div", { id: "background-content" }),
            h("main", { class: {
                    'inner-scroll': true,
                    'scroll-x': scrollX,
                    'scroll-y': scrollY,
                    'overscroll': (scrollX || scrollY) && forceOverscroll
                }, ref: el => this.scrollEl = el, onScroll: (this.scrollEvents) ? ev => this.onScroll(ev) : undefined },
                h("slot", null)),
    ...
    static get methods() { return {
        ...
        "scrollToPoint": {
            "complexType": {
                "signature": "(x: number | null | undefined, y: number | null | undefined, duration?: number) => Promise<void>",
                "parameters": [{
                        "tags": [{
