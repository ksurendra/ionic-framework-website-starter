...
export class ListHeader {
    render() {
        ...
        return (h(Host, { class: Object.assign(Object.assign({}, createColorClasses(this.color)), { [mode]: true, [`list-header-lines-${lines}`]: lines !== undefined }) },
            h("div", { class: "list-header-inner" },
                h("slot", null))));
    }
