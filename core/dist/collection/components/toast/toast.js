...
export class Toast {
    ...
    render() {
        ...
        return (h(Host, { style: {
            ...
            }, class: Object.assign(Object.assign(Object.assign({ [mode]: true }, createColorClasses(this.color)), getClassMap(this.cssClass)), { 'toast-translucent': this.translucent }), onIonToastWillDismiss: this.dispatchCancelHandler },
