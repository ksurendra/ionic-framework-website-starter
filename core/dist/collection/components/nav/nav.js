...
export class Nav {
    ...
    static get methods() { return {
        ...
        "insertPages": {
            "complexType": {
                "signature": "(insertIndex: number, insertComponents: NavComponent[], opts?: NavOptions | null | undefined, done?: TransitionDoneFn | undefined) => Promise<boolean>",
                "parameters": [{
                        "tags": [{
        ...
        "setPages": {
            "complexType": {
                "signature": "(views: any[], opts?: NavOptions | null | undefined, done?: TransitionDoneFn | undefined) => Promise<boolean>",
                "parameters": [{
                        "tags": [{
